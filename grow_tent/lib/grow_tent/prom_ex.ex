defmodule GrowTent.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule GrowTentWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :grow_tent
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: GrowTentWeb.Router},
      # Plugins.Ecto,
      # Plugins.Oban,
      Plugins.PhoenixLiveView,

      # Add your own PromEx metrics plugins
      GrowTent.Sensors.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:grow_tent, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
